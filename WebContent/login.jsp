      ...
      <div class="modal-body">
          <form class="form col-md-12 center-block" action="doLogin.do" method="post" name="Login" onSubmit="return Check(this)">
            <div class="form-group">
              <input type="text" name="user_id" class="form-control input-lg" placeholder="用户ID">
            </div>
            <div class="form-group">
         ...
         <a href="register.jsp" class="btn btn-primary">注册</a>
          <button class="submit btn btn-primary" onClick="addCookie("user_id",user_id,1)">登录</button>
