...
<script type="text/javascript">
	function Check(theform) {
		...
		if (Register.user_id.value == "") {
			...
			m = "请确认密码";
			alert(m);
		}else if(Register.password.value!=Register.pwdConfirm.value){
			m="两次输入的密码不一致";
			alert(m);
		}
		else {
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form col-md-12 center-block" name="Register"
						...
						<div class="form-group">
							<label>密码</label><label style="font-size: 10px"></label> <input type="password" name="password"
						...
						<div class="form-group">
							<label>性别</label>
							<div class="radio">
								<label> <input type="radio" name="sex" id="maleRadios"
									value="男" checked>男
								</label>
							</div>
							<div class="radio">
